...
class ListPatientCholComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {
            patients: [],
    ...
    editPatient(id) { 
        alertify.confirm(
            "Are you sure to edit this patient's medical program data.",
            ok => {
                window.localStorage.setItem("id", id);
                this.props.history.push('/edit-patientChol');
            },
            cancel => { alertify.error('Cancel'); }
        ).set({ title: "Attention" }).set({ transition: 'slide' }).show();
    }
...
export default ListPatientCholComponent;